    ...
    return function(e) {
            ...
            h = r(18);
        {
            ...
            if (e) {
                ...
                let t;
                (0, s.isFetchSupported)() && (t = r(23).PDFFetchStream), (0, n.setPDFNetworkStreamFactory)(r => t && (0, s.isValidFetchUrl)(r.url) ? new t(r) : new e(r))
            }
        }
    }, function(e, t, r) {
        "use strict";
        ...
        function getDocument(e) {
            ...
            return i.promise.then((function() {
                ...
                const e = _fetchDocument(i, s, n, a),
            ...
            l = function() {
                        ...
                        if (t.kind === s.ImageKind.GRAYSCALE_1BPP) {
                            ...
                            for (n = 0; n < u; n++) {
                                for (a = n < d ? 16 : h, r = 0, i = 0; i < a; i++) {
                                    for (var x = A - g, C = 0, P = x > y ? c : 8 * x - 7, k = -8 & P, R = 0, w = 0; C < k; C += 8) w = f[g++], b[r++] = 128 & w ? v : S, b[r++] = 64 & w ? v : S, b[r++] = 32 & w ? v : S, b[r++] = 16 & w ? v : S, b[r++] = 8 & w ? v : S, b[r++] = 4 & w ? v : S, b[r++] = 2 & w ? v : S, b[r++] = 1 & w ? v : S;
                                    for (; C < P; C++) 0 === R && (w = f[g++], R = 128), b[r++] = w & R ? v : S, R >>= 1
                                }
                                for (; r < _;) b[r++] = 0;
                ...
                function r(e, t) {
                    for (var r = t.height, s = t.width, n = r % 16, i = (r - n) / 16, a = 0 === n ? i : i + 1, o = e.createImageData(s, 16), l = 0, c = t.data, h = o.data, d = 0; d < a; d++) {
                        for (var u = d < i ? 16 : n, p = 3, g = 0; g < u; g++)
                ...
                for (var b in e.prototype = {
                        ...
                        beginSMaskGroup: function() {
                            ...
                            this.ctx.save();
                            var o = n.context;
                            o.scale(1 / e.scaleX, 1 / e.scaleY), o.translate(-e.offsetX, -e.offsetY), o.transform.apply(o, a), e.startTransformInverse = o.mozCurrentTransformInverse, l(i, o), this.ctx = o, this.setGState([
                                ["BM", "source-over"],
                                ["ca", 1],
                                ["CA", 1]
                        ...
                        showText: function(e) {
                            ...
                            for (v = 0; v < d; ++v) {
                                ...
                                if ((0, s.isNum)(x)) S += p * x * n / 1e3;
                                    ...
                                    if (r.remeasure && O > 0) {
                                        var N = 1e3 * i.measureText(I).width / n * a;
                                        if (O < N && this.isFontSubpixelAAEnabled) {
                                            var D = O / N;
                                            F = !0, i.save(), i.scale(D, 1), C /= D
                                        } else O !== N && (C += (O - N) / 2e3 * n / a)
                                    }(x.isInFont || r.missingFile) && (m && !M ? i.fillText(I, C, P) : (this.paintChar(I, C, P, A), M && (k = C + M.offset.x / a, R = P - M.offset.y / a, this.paintChar(M.fontChar, k, R, A)))), S += u ? O * f - L * c : O * f + L * c, F && i.restore()
                                }
                            }
                            ...
                            if (!(o.textRenderingMode === s.TextRenderingMode.INVISIBLE) && 0 !== c) {
                                for (this._cachedGetSinglePixelWidth = null, a.save(), a.transform.apply(a, o.textMatrix), a.translate(o.x, o.y), a.scale(g, h), t = 0; t < m; ++t)
                                    if (r = e[t], (0, s.isNum)(r)) i = d * r * c / 1e3, this.ctx.translate(i, 0), o.x += i * g;
                                        ...
                                        else(0, s.warn)(`Type3 character "${r.operatorListId}" is not available.`)
                        ...
                        beginGroup: function(e) {
                            ...
                            }) : (t.setTransform(1, 0, 0, 1, 0, 0), t.translate(a, o), t.scale(d, u)), l(t, f), this.ctx = f, this.setGState([
                                ["BM", "source-over"],
                                ["ca", 1],
                                ["CA", 1]
        ...
        var a = function() {
            function e(e, t, r, s, n, i, a, o) {
                ...
                if (!(g >= b))
                    for (var _, y, v, S, x, C, P, k, R = h[i], w = h[i + 1], T = h[i + 2], E = h[a], F = h[a + 1], L = h[a + 2], I = h[o], M = h[o + 1], O = h[o + 2], N = Math.round(g), D = Math.round(b), j = N; j <= D; j++) {
                        if (j < m) {
                            let e;
                            e = j < g ? 0 : g === m ? 1 : (g - j) / (g - m), _ = p - (p - f) * e, y = R - (R - E) * e, v = w - (w - F) * e, S = T - (T - L) * e
                        } else {
                            let e;
                            e = j > b ? 1 : m === b ? 0 : (m - j) / (m - b), _ = f - (f - A) * e, y = E - (E - I) * e, v = F - (F - M) * e, S = L - (L - O) * e
                        }
                        let e;
                        e = j < g ? 0 : j > b ? 1 : (g - j) / (g - b), x = p - (p - A) * e, C = R - (R - I) * e, P = w - (w - M) * e, k = T - (T - O) * e;
                        for (var U = Math.round(Math.min(_, x)), q = Math.round(Math.max(_, x)), W = u * j + 4 * U, G = U; G <= q; G++) e = (_ - G) / (_ - x), e < 0 ? e = 0 : e > 1 && (e = 1), d[W++] = y - (y - C) * e | 0, d[W++] = v - (v - P) * e | 0, d[W++] = S - (S - k) * e | 0, d[W++] = 255
                    }
            }
            ...
            return function(e, r, s, n, i, a, o, l) {
                ...
                if (l.isEnabled) c = l.drawFigures({
                    ...
                    var C = (h = o.getCanvas("mesh", S, x, !1)).context,
                        P = C.createImageData(A, b);
                    if (a) {
                        var k = P.data;
                        for (d = 0, u = k.length; d < u; d += 4) k[d] = a[0], k[d + 1] = a[1], k[d + 2] = a[2], k[d + 3] = 255
                    }
                    for (d = 0; d < i.length; d++) t(P, i[d], v);
                    C.putImageData(P, 2, 2), c = h.canvas
                }
                return {
                    canvas: c,
                    offsetX: p - 2 * _,
        ...
        t.PDFDataTransportStream = class {
            constructor(e, t) {
                (0, s.assert)(t, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.'), this._queuedChunks = [], this._progressiveDone = e.progressiveDone || !1;
            ...
            _onReceiveData(e) {
                ...
                if (void 0 === e.begin) this._fullRequestReader ? this._fullRequestReader._enqueue(t) : this._queuedChunks.push(t);
                    ...
                    (0, s.assert)(r, "_onReceiveData - no `PDFDataTransportStreamRangeReader` instance found.")
                }
            }
            ...
            return {
                ...
                drawFigures: function(e, n, l, h, d) {
                    ...
                    for (f = 0, m = h.length; f < m; f++) {
                        ...
                        switch (P.type) {
                            case "lattice":
                                var w = P.verticesPerRow;
                                A = k.length / w | 0;
                                for (var T = 1; T < A; T++)
                                    for (var E = T * w + 1, F = 1; F < w; F++, E++) _[x] = v[k[E - w - 1]], _[x + 1] = v[k[E - w - 1] + 1], _[x + 2] = v[k[E - w]], _[x + 3] = v[k[E - w] + 1], _[x + 4] = v[k[E - 1]], _[x + 5] = v[k[E - 1] + 1], y[C] = S[R[E - w - 1]], y[C + 1] = S[R[E - w - 1] + 1], y[C + 2] = S[R[E - w - 1] + 2], y[C + 3] = S[R[E - w]], y[C + 4] = S[R[E - w] + 1], y[C + 5] = S[R[E - w] + 2], y[C + 6] = S[R[E - 1]], y[C + 7] = S[R[E - 1] + 1], y[C + 8] = S[R[E - 1] + 2], _[x + 6] = _[x + 2], _[x + 7] = _[x + 3], _[x + 8] = _[x + 4], _[x + 9] = _[x + 5], _[x + 10] = v[k[E]], _[x + 11] = v[k[E] + 1], y[C + 9] = y[C + 3], y[C + 10] = y[C + 4], y[C + 11] = y[C + 5], y[C + 12] = y[C + 6], y[C + 13] = y[C + 7], y[C + 14] = y[C + 8], y[C + 15] = S[R[E]], y[C + 16] = S[R[E] + 1], y[C + 17] = S[R[E] + 2], x += 12, C += 18;
                                break;
                            case "triangles":
                                for (var L = 0, I = k.length; L < I; L++) _[x] = v[k[L]], _[x + 1] = v[k[L] + 1], y[C] = S[R[L]], y[C + 1] = S[R[L] + 1], y[C + 2] = S[R[L] + 2], x += 2, C += 3
                        }
                    }
                    ...
                    return g.bindBuffer(g.ARRAY_BUFFER, O), g.bufferData(g.ARRAY_BUFFER, y, g.STATIC_DRAW), g.enableVertexAttribArray(u.colorLocation), g.vertexAttribPointer(u.colorLocation, 3, g.UNSIGNED_BYTE, !1, 0, 0), g.uniform2f(u.scaleLocation, d.scaleX, d.scaleY), g.uniform2f(u.offsetLocation, d.offsetX, d.offsetY), g.drawArrays(g.TRIANGLES, 0, b), g.flush(), g.deleteBuffer(M), g.deleteBuffer(O), p
                },
                cleanup() {
        ...
        var s = r(2),
            n = function() {
                ...
                function t(t, r, n) {
                    ...
                    if (f && (h.vertical ? o.canvasWidth = r.height * t._viewport.scale : o.canvasWidth = r.width * t._viewport.scale), t._textDivProperties.set(a, o), t._textContentStream && t._layoutText(a), t._enhanceTextSelection) {
                        var m = 1,
                            A = 0;
                        0 !== c && (m = Math.cos(c), A = Math.sin(c));
                        var b, _, y = (h.vertical ? r.height : r.width) * t._viewport.scale,
                            v = d;
                        0 !== c ? (b = [m, A, -A, m, p, g], _ = s.Util.getAxialAlignedBoundingBox([0, 0, y, v], b)) : _ = [p, g, p + y, g + v], t._bounds.push({
                            left: _[0],
                            top: _[1],
                            right: _[2],
                            bottom: _[3],
        ...
        t.SVGGraphics = a;
        {
            ...
            t.SVGGraphics = a = class {
                ...
                beginText() {
                    const e = this.current;
                    e.x = e.lineX = 0, e.y = e.lineY = 0, e.textMatrix = s.IDENTITY_MATRIX, e.lineMatrix = s.IDENTITY_MATRIX, e.textMatrixScale = 1, e.tspan = this.svgFactory.createElement("svg:tspan"), e.txtElement = this.svgFactory.createElement("svg:text"), e.txtgrp = this.svgFactory.createElement("svg:g"), e.xcoords = [], e.ycoords = []
                }
                moveText(e, t) {
                    const r = this.current;
                    r.x = r.lineX += e, r.y = r.lineY += t, r.xcoords = [], r.ycoords = [], r.tspan = this.svgFactory.createElement("svg:tspan"), r.tspan.setAttributeNS(null, "font-family", r.fontFamily), r.tspan.setAttributeNS(null, "font-size", o(r.fontSize) + "px"), r.tspan.setAttributeNS(null, "y", o(-r.y))
                }
                showText(t) {
                    ...
                    let y = n.textMatrix;
                    0 !== n.textRise && (y = y.slice(), y[5] += n.textRise), n.txtElement.setAttributeNS(null, "transform", `${l(y)} scale(${o(p)}, -1)`), n.txtElement.setAttributeNS(r, "xml:space", "preserve"), n.txtElement.appendChild(n.tspan), n.txtgrp.appendChild(n.txtElement), this._ensureTransformGroup().appendChild(n.txtElement)
                }
                ...
                setFont(e) {
                    ...
                    n < 0 ? (n = -n, t.fontDirection = -1) : t.fontDirection = 1, t.fontSize = n, t.fontFamily = r.loadedName, t.fontWeight = i, t.fontStyle = a, t.tspan = this.svgFactory.createElement("svg:tspan"), t.tspan.setAttributeNS(null, "y", o(-t.y)), t.xcoords = [], t.ycoords = []
                }
                endText() {
                    const e = this.current;
                ...
                setFillRGBColor(e, t, r) {
                    this.current.fillColor = s.Util.makeCssRgb(e, t, r), this.current.tspan = this.svgFactory.createElement("svg:tspan"), this.current.xcoords = [], this.current.ycoords = []
                }
                setStrokeColorN(e) {
                ...
                shadingFill(e) {
                    ...
                    p.setAttributeNS(null, "x", c), p.setAttributeNS(null, "y", h), p.setAttributeNS(null, "width", d - c), p.setAttributeNS(null, "height", u - h), p.setAttributeNS(null, "fill", this._makeShadingPattern(e)), this.current.fillAlpha < 1 && p.setAttributeNS(null, "fill-opacity", this.current.fillAlpha), this._ensureTransformGroup().appendChild(p)
                }
                ...
                _makeTilingPattern(e) {
                    ...
                    return this.executeOpTree(this.convertOpList(r)), this.svg = x, this.transformMatrix = C, this.current.fillColor = P, this.current.strokeColor = k, S.appendChild(R.childNodes[0]), this.defs.appendChild(S), `url(#${u})`
                }
        ...
        t.PDFNodeStream = class {
            ...
            getFullReader() {
                return (0, s.assert)(!this._fullRequestReader, "PDFNodeStream.getFullReader can only be called once."), this._fullRequestReader = this.isFsUrl ? new f(this) : new p(this), this._fullRequestReader
            }
            getRangeReader(e, t) {
                if (t <= this._progressiveDataLength) return null;
        ...
        class h {
            ...
            async read() {
                ...
                this._loaded += e.length, this.onProgress && this.onProgress({
                    loaded: this._loaded,
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            function o(e) {
                const t = e.indexOf("'");
                if (-1 === t) return e;
                return n(e.slice(0, t), e.slice(t + 1).replace(/^[^']*'/, ""))
            }
        ...
        t.PDFFetchStream = class {
            ...
            getFullReader() {
                return (0, s.assert)(!this._fullRequestReader, "PDFFetchStream.getFullReader can only be called once."), this._fullRequestReader = new o(this), this._fullRequestReader
            }
            getRangeReader(e, t) {
                if (t <= this._progressiveDataLength) return null;
